...
namespace ContentLocalizationSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20260429214358_HardenApiTokenScoping")]
    partial class HardenApiTokenScoping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContentLocalizationSaaS.Domain.ApiToken", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId", "IsRevoked", "ExpiresUtc");

                    b.ToTable("api_tokens", (string)null);
                });

            modelBuilder.Entity("ContentLocalizationSaaS.Domain.ApiTokenProjectScope", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ApiTokenId", "ProjectId")
                        .IsUnique();

                    b.ToTable("api_token_project_scopes", (string)null);
                });
            ...
            modelBuilder.Entity("ContentLocalizationSaaS.Domain.ApiTokenProjectScope", b =>
                {
                    b.HasOne("ContentLocalizationSaaS.Domain.ApiToken", null)
                        .WithMany()
