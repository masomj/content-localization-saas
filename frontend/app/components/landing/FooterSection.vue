...
const footerLinks = {
  ...
  Company: [
    { label: 'About', href: 'https://vanguarddigitalsolutions.co.uk' },
    { label: 'Contact', href: 'mailto:hello@vanguarddigitalsolutions.co.uk' },
  ],
  Resources: [
  ...
  Legal: [
    ...
    { label: 'Security', href: 'https://docs.openclaw.ai' },
  ],
}
</script>
    ...
    <div class="footer-container">
          ...
          <div v-for="(links, category) in footerLinks" :key="category" class="footer-column">
            ...
            <ul class="footer-list">
              <li v-for="link in links" :key="link.label">
                <a :href="link.href" class="footer-link" :target="link.href.startsWith('http') ? '_blank' : undefined" :rel="link.href.startsWith('http') ? 'noopener noreferrer' : undefined">{{ link.label }}</a>
              </li>
            </ul>
          </div>
        </nav>
      ...
      <div class="footer-bottom">
        ...
        <div class="footer-social" aria-label="Social media links">
          ...
          <a href="https://github.com/masomj/content-localization-saas" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a href="https://www.linkedin.com/company/vanguard-digital-solutions/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
